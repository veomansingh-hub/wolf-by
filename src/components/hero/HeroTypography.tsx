...
export function HeroTypography() {
  ...
  return (
    <>
      ...
      >
        {/* Small intro label */}
        <div className="mb-6 font-sans text-[10px] sm:text-xs tracking-[0.2em] uppercase text-charcoal/80 pointer-events-auto font-semibold">
          Private Wildlife Journeys
        </div>

        {/* Main Headline - Massive, distinct fonts, clean, high contrast */}
        <h1 className="mb-10 leading-[0.85] flex flex-col">
          <span 
          ...
          <span 
            ...
            style={{ fontSize: 'clamp(5rem, 13vw, 11rem)', transform: 'translateY(-0.05em)' }}
          >
            NATURE
          </span>
        </h1>
        ...
        {/* Description */}
        <p 
          className="mb-12 max-w-md font-sans text-charcoal/90 leading-relaxed pointer-events-auto font-medium"
        ...
        {/* Trust Line */}
        <div className="font-sans text-[9px] sm:text-[10px] tracking-[0.2em] uppercase text-charcoal/70 pointer-events-auto font-semibold">
